      ...
      <div class="header-bar d-flex justify-content-between">
          <div class="d-flex align-items-center">
              <a href="#" class="logo-icon me-3 d-none">
                  <img loading="lazy" src="{{ getAppLogo('dark') }}" height="30" class="small"
                      alt="">
                  <span class="big">
                      <img loading="lazy" src="{{ getAppLogo('light') }}" height="24" class="logo-light-mode"
                          alt="">
                      <img loading="lazy" src="{{ getAppLogo('dark') }}" height="24"
          ...
          <ul class="list-unstyled mb-0">
              ...
              <li class="list-inline-item mb-0 ms-1 d-none">
                      ...
                      <div class="dropdown-menu dd-menu shadow rounded border-0 mt-3 p-0" data-simplebar
                          ...
                          <div class="p-3">
                              ...
                              <a href="#!" class="dropdown-item features feature-primary key-feature p-0 mt-3">
                                  <div class="d-flex align-items-center">
                                      <img loading="lazy" src="{{ asset('assets/user/images/client/04.jpg') }}"
                                          class="avatar avatar-md-sm rounded-circle border shadow me-2" alt="">
                                      <div class="flex-1">
                                          <h6 class="mb-0 text-dark title"><span class="fw-bold">Message</span> from
                                              Luis</h6>
                  ...
                  <div class="dropdown dropdown-primary">
                      ...
                      <div class="dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3"
                          ...
                          <a class="dropdown-item text-dark" href="#" onclick="$('#logout-form').submit();"><span
                                  class="mb-0 d-inline-block me-1"><i class="ti ti-logout"></i></span>{{ __('auth.logout') }}</a>
                      </div>
                  </div>
              </li>
          </ul>
