...
class ContactTransformer extends TransformerAbstract
{
    ...
    public function getActions($contact)
    {
        ...
        <a data-bs-toggle="modal" data-bs-target="#delete-modal" data-delete-url="' . route('user.contacts.destroy', encrypt($contact->id)) . '"
    ...
    public function getStatusColumn($contact)
    {
        ...
        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="status"  ' . $is_checked . ' data-route="' . route('user.contacts.toggle_status') . '" data-id="' . $contact->id . '" onclick="toggleStatus($(this));">
    </div>';
        return $html;
    }
